...
const sectionSchema = new mongoose.Schema(
  {
    ...
    imageandtext: {
      ...
      description: {
        type: String,
        default:
          "We Work Together, to design, create and produce work that we are proud of for folks that we believe in. We would be more than happy to work on your project. To help you business evolve to the next level",
      },
      imageurl: {
        type: String,
      },
    ...
    textandchecklist: {
      text: {
        type: String,
        default:
          "Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo repellat incidunt modi? Rem, fugiat neque provident atque commodi eaque quibusdam? Quo ipsum dolor officiis alias eaque laudantium, explicabo odio sequi.",
      },
      checklist: {
        type: [Object],
        default: [
    ...
    headertextandimage: {
      header: {
        type: String,
        default:
          "Being the strategic part of the page that people see in the first seconds of loading a website.",
      },
      subtitle: {
        type: String,
        default:
    ...
    headertextheroimage: {
      ...
      subtitle: {
        type: String,
        default:
          "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad sequi odit, quisquam dolore illum tenetur magni quam rerum sint qui corrupti dignissimos velit ea beatae molestias! Quod quasi modi quo.",
      },
      heroimageurl: {
        type: String,
      },
...
sectionSchema.index({ name: 1, userId: 1 });
