  ...
  const handleDownloadPdf = () => {
    ...
    return <>
     ...
     <div className="download-pdf-section text-center mt-3">
         <Button disabled={ purchaseHistory.length === 0 } onClick={handleDownloadPdf} block className="download-pdf__btn">Download PDF</Button>
     </div>
