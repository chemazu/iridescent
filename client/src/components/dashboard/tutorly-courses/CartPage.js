...
import AuthenticationModal from "../../school/AuthenticationModal";
import TransactionSuccessModal from "../../school/TransactionSuccessModal";
import PaystackPop from "@paystack/inline-js";
import SecondaryPagesNavbar from "./SecondaryPagesNavbar";
import setAuthToken from "../../../utilities/setAuthToken";
import CartItem from "../../school/CartItem";
import setDocumentTitle from "../../../utilities/setDocumentTitle";
import SubdomainNotFoundPage from "../Subdomain404";
...
import "../../../custom-styles/dashboard/tuturly-courses/TuturlyCartpage.css";
        ...
        <>
          {!pageLoading && school === null && theme === null ? (
            ...
            <>
              ...
              <div className="cart-page-contents">
                <div
                  style={{
                    ...
                    <Row>
                      ...
                      >
                        <div className="cart-summary mb-3">
                          ...
                          <Button
                            style={{
                              border: " 0.00045px solid rgb(255, 255, 255)",
                              backgroundColor:
              ...
              <div
                style={{
                  ...
                  borderTop: `1px solid ${tuturlyTheme.themestyles.primarytextcolor}`,
                }}
              ...
              <TransactionSuccessModal
                ...
                theme={tuturlyTheme}
                successUrlRedirect="/dashboard/home"
              />
            </>
          )}
        </>
