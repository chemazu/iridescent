      ...
      <div className="video-player__controls-wrapper" ref={ref}>
        ...
        <div className="video-player__bottom-controls">
          ...
          <div className="bottom-controls">
            <div
              onClick={onPlayPause}
              className="video-player__bottom-controls-play-icon ml-3"
            >
              {playing ? (
                <i className="fas fa-pause"></i>
              ) : (
            ...
            <div
              onClick={onMute}
              className="video-player__bottom-controls-volume-icon ml-2"
            >
              {muted ? (
            ...
            <div
              ...
              className="video-player__playback-time"
            >
              ...
              >
                {[0.5, 1, 1.5, 2].map((rate) => (
                  <Button
                    ...
                    className={`playback-rate__btn-item ${
